                ...
                <form role="form">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtFormerLastName" runat="server" class="form-control input-lg" placeholder="Former Last Name"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtPrefferedFirstName" runat="server" class="form-control input-lg" placeholder="Preffered First Name"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtFamilyName" runat="server" class="form-control input-lg" placeholder="Family Name"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtDob" runat="server" class="form-control input-lg" TextMode="Date"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="This is required Field" ControlToValidate="txtDob" ForeColor="Red" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtNationality" runat="server" class="form-control input-lg" placeholder="Nationality"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="This is required Field" ControlToValidate="txtNationality" ForeColor="Red" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtImmigrationStatus" runat="server" class="form-control input-lg" placeholder="Immigration Status"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtFirstLanguageSpoke" runat="server" class="form-control input-lg" placeholder="First Language Spoken"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtCurrentAddress" runat="server" class="form-control input-lg" placeholder="Current Address" TextMode="MultiLine"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="This is required Field" ControlToValidate="txtCurrentAddress" ForeColor="Red" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtPermanentAddress" runat="server" class="form-control input-lg" placeholder="Permanent Address" TextMode="MultiLine"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtNameofHighSchool" runat="server" class="form-control input-lg" placeholder="Name of High School"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon">Date of school leaving</span>
                                <asp:TextBox ID="txtDateOFSchoolLeaving" runat="server" class="form-control input-lg" TextMode="Date"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtNameofPostSecondarySchool" runat="server" class="form-control input-lg" placeholder="Name of Post Secondary School"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon">Date last attended Postsecondary</span>
                                <asp:TextBox ID="DatelastattendedPostsecondary" runat="server" class="form-control input-lg"  TextMode="Date"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlField" runat="server" CssClass="form-control input-lg">
                                    <asp:ListItem Value="0">--Select Field Of Study--</asp:ListItem>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="This is required Field" ControlToValidate="ddlField" InitialValue="0" ForeColor="Red" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    ...
                    <div class="row">
                       <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon">IELTS</span>
                               <asp:FileUpload ID="pdfIELTS" runat="server" CssClass="form-control"/>                         
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <asp:TextBox ID="txtTerm" runat="server" class="form-control input-lg" placeholder="Term you want to  begin"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6"><a href="StudentLogin.aspx" class="btn btn-success btn-block btn-lg">Sign In</a></div>
                    </div>
                </form>
            </div>
        </div>
